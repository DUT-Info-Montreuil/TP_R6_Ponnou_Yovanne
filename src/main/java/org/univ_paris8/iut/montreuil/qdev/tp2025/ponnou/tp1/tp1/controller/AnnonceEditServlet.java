...
public class AnnonceEditServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("title", annonce.getTitle());
        request.setAttribute("description", annonce.getDescription());
        request.setAttribute("adress", annonce.getAdress());
        request.setAttribute("mail", annonce.getMail());
        request.setAttribute("selectedCategoryId", annonce.getCategory().getId().toString());
